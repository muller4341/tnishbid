  ...
  return (
    <div className="max-w-md mx-auto mt-16 bg-white rounded-2xl shadow-xl shadow-slate-200/50 p-8 border border-slate-100">
      <div className="text-center mb-8">
        ...
        <p className="text-slate-500">Join Tinish Bid with your phone number today</p>
      </div>
      ...
      <p className="mt-6 text-center text-slate-500 text-sm">
        Already have an account? <Link to="/login" state={{ from: redirectPath }} className="text-indigo-600 font-semibold hover:underline">Sign in</Link>
      </p>
    </div>
  );
};
